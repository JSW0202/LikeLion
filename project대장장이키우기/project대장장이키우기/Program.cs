                ...
                else if (input == 2)
                {
                    if (pmoney >= 1000)
                    {
                        ...
                        for (int i = 1; i <= 20; i++)
                        {
                            ...
                            else if (rnd >= 2 && rnd <= 6) Console.WriteLine("도끼등급 SS");
                            else if (rnd >= 7 && rnd <= 17) Console.WriteLine("도끼등급 S");
                            else if (rnd >= 18 && rnd <= 38) Console.WriteLine("도끼등급 A");
                            else if (rnd >= 39 && rnd <= 72) Console.WriteLine("도끼등급 B");
